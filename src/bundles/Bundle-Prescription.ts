 ...
 */
  ...
  options.compositionObj.id = curBundle.data.entry.filter((el:any)=> el.resource.resourceType == "Composition")[0].resource.id
  const documentReferenceId= curBundle.data.entry.filter((el:any)=> el.resource.resourceType == "DocumentReference")[0].resource.id
