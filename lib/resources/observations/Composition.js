    ...
    getFHIR(options) {
        const body = {
            ...
            "meta": {
                ...
                "profile": [
                    exports.compositionTypeArrey.filter(el => el.type == options.type)[0].url
                ]
            },
            "language": "en-IN",
            "text": {
                ...
                "coding": [
                    {
                        ...
                        "code": exports.compositionTypeArrey.filter(el => el.type == options.type)[0].code,
                        "display": exports.compositionTypeArrey.filter(el => el.type == options.type)[0].text
                    }
                ],
                "text": exports.compositionTypeArrey.filter(el => el.type == options.type)[0].text
            },
            "subject": {
