...
const searchsimple = async () => {
  ...
  const res = await gcpFhirSearch.search("Composition", `_id=43213a09-d546-4e44-8759-4a6ce4fa2087&_include=Composition:author&_include=Composition:patient&_include=Composition.section`)
  console.log(res.data.entry)
